			...
			<nav id="sidebarMenu"
				...
				<div class="position-sticky pt-3">
					<ul class="nav flex-column tab">
						<li data-tab="myPage_review" class="nav-item tabmenu" id="default">
						<a class="nav-link active"aria-current="page" href="#"><i class="bi bi-card-text fs-5"></i>
								내가 작성한 리뷰 </a></li>
						<li data-tab="myPage_query" class="nav-item tabmenu">
						<a class="nav-link" aria-current="page"	href="#"><i class="bi bi-chat-text fs-5"></i> 
								문의 내역 </a></li>
						<li data-tab="myPage_info" class="nav-item tabmenu"">
